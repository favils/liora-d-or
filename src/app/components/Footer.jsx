    ...
    return (
        <section class="py-10 sm:pt-16 lg:pt-24">
            ...
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-4 gap-y-16 gap-x-12">
                    ...
                    <div>
                        ...
                        <ul class="mt-6 space-y-4">
                            ...
                            <li>
                                <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Products </a>
                            </li>
                ...
                <p class="text-sm text-center text-gray-600">© Copyright 2025, All Rights Reserved by Liora</p>
            </div>
        </section>
    )
}